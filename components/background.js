...
function Background() {
    return (
        <Section className={classNamees.background}>
            ...
            <p>As a back-end developer intern at <a href="https://www.zuapp.co/" className={classNamees.background_link} target="_blank" rel="noreferrer">ZuAi</a>, tested authentication APIs, developed image uploading and retrieval APIs, and collaborated effectively with cross-functional teams. </p>
