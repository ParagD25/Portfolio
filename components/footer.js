    ...
    return (
        <footer className={classes.footer}>
            <div className={classes.developed}>
                Developed By <a href="https://github.com/ParagD25/Portfolio" target="_blank" rel="noopener noreferrer" className={classes.link}>Parag Durafe</a> &amp; <a href="https://github.com/bilal-23/personal-portfolio" target="_blank" rel="noopener noreferrer" className={classes.link}>Bilal Mansuri</a>
            </div>
